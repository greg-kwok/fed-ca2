...
/*function to write table row for each day of thr month*/
function calDays(calDate){
   //determind the starting day of the month
   var day=new Date(calDate.getFullYear(),calDate.getMonth(),1);
   var weekDay=day.getDay();
   //wwrite blacnk cells preceding the starting date
   var htmlCode = "<tr>";
